import { ISummaries, RANGE, SLICE_BY, SUMMARY_RANGE } from "../types/defaults";
...
class WakaTimeApi {
  ...
  getUserSummaries(
    ...
    return this.axiosConfig
      .get(`users/${userId}/summaries`, { params })
      .then((response) => response.data);
  }
  ...
  getStats(
    ...
    return this.axiosConfig
      .get(`users/${userId}/stats/${range}`, args)
      .then((response) => response.data);
  }
  ...
  getUserProjects(userId: String, query?: String) {
    ...
    return this.axiosConfig
      .get(`users/${userId}/projects`, { params })
      .then((response) => response.data);
  }
  ...
  getPrivateLeaderboardsLeaders(
    ...
    return this.axiosConfig
      .get(`users/${userId}/leaderboards/${board}`, { params })
      .then((response) => response.data);
  }
  ...
  getMyPrivateLeaderboardsLeaders(
    ...
    return this.getPrivateLeaderboardsLeaders(
      "current",
      board,
      language,
      country_code,
  ...
  getUsersOrgDashboard(userId: String, org: String) {
    ...
    return this.axiosConfig
      .get(`users/${userId}/orgs/${org}/dashboards`)
      .then((response) => response.data);
  }
  ...
  getOrgDashboardMembers(userId: String, org: String, dashboard: String) {
    ...
    return this.axiosConfig
      .get(`users/${userId}/orgs/${org}/dashboards/${dashboard}/members`)
      .then((response) => response.data);
  }
  ...
  orgDashboardMemberSummaries(
    ...
    return this.axiosConfig
      .get(
        `users/${userId}/orgs/${org}/dashboards/${dashboard}/members/${member}/summaries`,
        { params }
      )
      .then((response) => response.data);
  }
  ...
  getMyOrgDashboardMemberSummaries(
    ...
    return this.orgDashboardMemberSummaries(
      "current",
      org,
      dashboard,
      member,
  ...
  orgDashboardMemberDurations(
    ...
    return this.axiosConfig
      .get(
        `users/${userId}/orgs/${org}/dashboards/${dashboard}/members/${member}/durations`,
        { params }
      )
      .then((response) => response.data);
  }
  ...
  getMyOrgDashboardMemberDurations(
    ...
    return this.orgDashboardMemberDurations(
      "current",
      org,
      dashboard,
      member,
  ...
  getUserMachineNames(userId: String) {
    ...
    return this.axiosConfig
      .get(`users/${userId}/machine_names`)
      .then((response) => response.data);
  }
  ...
  getUserHeartbeats(userId: String, date: Date) {
    ...
    return this.axiosConfig
      .get(`users/${userId}/heartbeats`, { params })
      .then((response) => response.data);
  }
  ...
  getUserExternalDurations(
    ...
    return this.axiosConfig
      .get(`users/${userId}/external_durations`, { params })
      .then((response) => response.data);
  }
  ...
  getMyExternalDurations(
    ...
    return this.getUserExternalDurations(
      "current",
      date,
      project,
      branches,
  ...
  async getUserDurations(
    ...
    return this.axiosConfig
      .get(`users/${userId}/durations`, { params })
      .then((response) => response.data);
  }
  ...
  getUserCommits(
    ...
    return this.axiosConfig
      .get(`users/${userId}/projects/${project}/commits`, { params })
      .then((response) => response.data);
  }
  ...
  getUserCommit(
    ...
    return this.axiosConfig
      .get(`users/${userId}/projects/${project}/commits/${hash}`, { params })
      .then((response) => response.data);
  }
  ...
  getUserAllTimeSinceToday(userId: String, project?: String) {
    ...
    return this.axiosConfig
      .get(`users/${userId}/all_time_since_today`, { params })
      .then((response) => response.data);
  }
